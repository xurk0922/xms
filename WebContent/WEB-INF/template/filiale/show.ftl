						...
						<div class="row">
							<div class="col-xs-12">
								...
								<!--
                                	表单开始
                                -->
								<form class="form-horizontal" role="form" method="POST" id="partAddForm" action="${basePath}/admin/filiale/modify">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="sn"> sn </label>

										<div class="col-sm-9">
											<input type="text" id="sn" placeholder="配件序列号" class="col-xs-10 col-sm-5" name="sn" value="${filiale.sn}" disabled/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="name" placeholder="配件名称" name="name" class="col-xs-10 col-sm-5" value="${filiale.name}" disabled />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="address" placeholder="公司地址" class="col-xs-10 col-sm-5" name="address" value="${filiale.address}" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="postcode" placeholder="邮编" class="col-xs-10 col-sm-5" name="postcode" value="${filiale.postcode}" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											...
											<div>
												...
												<textarea class="form-control" id="remark" placeholder="此处填写备注" readonly>${filiale.remark}</textarea>
											</div>
