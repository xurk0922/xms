			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					colModel:[
						...
						{name:'sn',index:'id', width:60, align:"center", sorttype:"int", editable: false},
						{name:'name',index:'name', width:150, align:"center",editable: true,editrules:{required:true}, editoptions:{size:"20",maxlength:"30"}},
						{name:'address',index:'wholesalePrice', width:60, align:"center", editable: true},
						{name:'postcode',index:'salePrice', width:60, align:"center", editable: true},
						{name:'tel',index:'tel', width:60, align:"center", sorttype:"int", editable: true},
					], 
					jsonReader: {
					...
					ondblClickRow: function(id){  
						window.open("${basePath}/admin/filiale/update?id=" + id);
					},
					...
					},
					{
						...
						beforeShowForm: function(e){
							...
							if (r) {
								...
								window.open("${basePath}/admin/filiale/show?id=" + id);
