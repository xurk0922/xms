						...
						<div class="row">
							<div class="col-xs-12">
								...
								<!--
                                	表单开始
                                -->
								<form class="form-horizontal" role="form" method="POST" id="partAddForm" action="${basePath}/admin/filiale/save">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="standard"> 地址 </label>
