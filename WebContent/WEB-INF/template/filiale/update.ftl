						...
						<div class="row">
							<div class="col-xs-12">
								...
								<!--
                                	表单开始
                                -->
								<form class="form-horizontal" role="form" method="POST" id="partAddForm" action="${basePath}/admin/filiale/update">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="sn"> sn </label>

										<div class="col-sm-9">
											<input type="text" id="sn" placeholder="配件序列号" class="col-xs-10 col-sm-5" name="sn" value="${filiale.sn}"/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="name" > 公司名称 </label>

										<div class="col-sm-9">
											<input type="text" id="name" placeholder="配件名称" name="name" class="col-xs-10 col-sm-5" value="${filiale.name}" />
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="standard"> 公司地址 </label>

										<div class="col-sm-9">
											<input type="text" id="address" placeholder="公司地址" class="col-xs-10 col-sm-5" name="address" value="${filiale.address}"/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="tel"> 公司电话 </label>

										<div class="col-sm-9">
											<input type="text" id="tel" placeholder="公司电话" class="col-xs-10 col-sm-5" name="tel" value="${filiale.tel}"/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="salePrice"> 邮编 </label>

										<div class="col-sm-9">
											<input type="text" id="postcode" placeholder="邮编" class="col-xs-10 col-sm-5" name="postcode" value="${filiale.postcode}"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											...
											<div>
												...
												<textarea class="form-control" id="remark" placeholder="此处填写备注" name="remark">${filiale.remark}</textarea>
											</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$("#sn").blur(function(){
					var sn = $("#sn").val();
				  	var res = $.ajax({
				  		url:"${basePath}/admin/filiale/checkSn",
				  		dataType:"text",
				  		data:{sn:sn},
				  		async:false,
