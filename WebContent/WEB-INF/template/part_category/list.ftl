								   ...
								   <div class="modal-dialog" style="width:400px">
								      <div class="modal-content">
								         ...
								         <div class="modal-body">
											<form method="POST" class="form-horizontal" role="form" id="partCategoryAddFrom">
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> sn </label>
													<div class="col-sm-9">
														<input type="text" id="form-field-1" name="sn" placeholder="sn" class="col-xs-10 col-sm-5" />
													</div>
												</div>
											 	<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 配件分类名 </label>
													<div class="col-sm-9">
														<input type="text" id="form-field-1" placeholder="配件分类名" name="name" class="col-xs-10 col-sm-5" />
													</div>
												</div>
												<div class="clearfix form-actions">
												<div class="col-md-offset-3 col-md-9">
													<button class="btn btn-info" type="button" id="submitPartCategoryAddFrom" data-dismiss="modal">
...
<![endif]-->
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				// ajaxForm
				$("#partCategoryAddFrom").ajaxForm(options);// ajaxForm
				
				// jQuery 表单验证
				$("#partCategoryAddFrom").validate({
					rules: {
						sn: "required",
						name: "required"
					},
				...
				jQuery(grid_selector).jqGrid({
					...
					colModel:[
						...
						{name:'sn',index:'id', width:60, align:"center", sorttype:"int", editable: false, editrules:{required:true, custom:true, custom_func:checkSn}},
						{name:'name',index:'name', width:150, align:"center",editable: true,editrules:{required:true}, editoptions:{size:"20",maxlength:"30"}},
					], 
					jsonReader: {
		...
		<script type="text/javascript" src='${basePath}/resources/js/jquery.validate.min.js'>
		<script type="text/javascript" src='${basePath}/resources/js/messages_zh.min.js'>
