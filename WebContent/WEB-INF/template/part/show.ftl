						...
						<div class="row">
							<div class="col-xs-12">
								...
								<!--
                                	表单开始
                                -->
								<form class="form-horizontal" role="form" method="" id="partAddForm" action="">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="sn"> sn </label>

										<div class="col-sm-9">
											<input type="text" id="sn" placeholder="配件序列号" class="col-xs-10 col-sm-5" name="sn" value="${part.sn}" disabled/>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="name" > 配件名称 </label>

										<div class="col-sm-9">
											<input type="text" id="name" placeholder="配件名称" name="name" class="col-xs-10 col-sm-5" value="${part.name}" disabled/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="standard"> 配件规格 </label>

										<div class="col-sm-9">
											<input type="text" id="standard" placeholder="配件规格" class="col-xs-10 col-sm-5" name="standard" value="${part.standard}" disabled/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="purchasePrice"> 进货价 </label>

										<div class="col-sm-9">
											<input type="text" id="purchasePrice" placeholder="进货价" class="col-xs-10 col-sm-5" name="purchasePrice" value="${part.purchasePrice}" disabled/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="salePrice"> 销售价 </label>

										<div class="col-sm-9">
											<input type="text" id="salePrice" placeholder="销售价" class="col-xs-10 col-sm-5" name="salePrice" value="${part.salePrice}" disabled/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="wholesalePrice"> 批发价 </label>

										<div class="col-sm-9">
											<input type="text" id="wholesalePrice" placeholder="批发价" class="col-xs-10 col-sm-5" name="wholesalePrice" value="${part.wholesalePrice}" disabled/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="partCategory"> 配件分类 </label>

										<div class="col-sm-9">
											
											<select class="width-40 chosen-select" id="partCategory" data-placeholder="选择一种分类" name="partCategoryId" disabled>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<select class="width-40 chosen-select" id="supplier" data-placeholder="选择一个供应商" name="supplierId" disabled>
												<option value="${part.supplier.id}">${part.supplier.name}</option>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											...
											<div>
												...
												<textarea class="form-control" id="remark" placeholder="此处填写备注" readonly>${part.remark}</textarea>
											</div>
