						...
						<div class="row">
							<div class="col-xs-12">
								...
								<!--
                                	表单开始
                                -->
								<form class="form-horizontal" role="form" method="POST" id="partAddForm" action="${basePath}/admin/part/save">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="sn"> sn </label>

										<div class="col-sm-9">
											<input type="text" id="sn" placeholder="配件序列号" class="col-xs-10 col-sm-5" name="sn" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="name" placeholder="配件名称" name="name" class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="standard" placeholder="配件规格" class="col-xs-10 col-sm-5" name="standard"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="purchasePrice" placeholder="进货价" class="col-xs-10 col-sm-5" name="purchasePrice"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="salePrice" placeholder="销售价" class="col-xs-10 col-sm-5" name="salePrice"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="wholesalePrice" placeholder="批发价" class="col-xs-10 col-sm-5" name="wholesalePrice"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											...
											<div>
												...
												<textarea class="form-control" id="remark" placeholder="此处填写备注"></textarea>
											</div>
