			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					colModel:[
						...
						{name:'legalPerson',index:'legalPerson', width:60, align:"center", editable: true},
						{name:'tel',index:'tel', width:60, align:"center", editable: true, formatter:function(cellvalue, options, rowObject) { if (cellvalue == null) return "-"; else return ""+cellvalue;}},
						{name:'postcode',index:'postcode', width:60, align:"center", editable: true},
					...
					ondblClickRow: function(id){  
						window.open("${basePath}/admin/supplier/update?id=" + id);
					},
					...
					},
					{
						...
						beforeShowForm: function(e){
							...
							if (r) {
								...
								window.open("${basePath}/admin/supplier/show?id=" + id);
