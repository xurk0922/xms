						...
						<div class="row">
							<div class="col-xs-12">
								...
								<!--
                                	表单开始
                                -->
								<form class="form-horizontal" role="form" method="POST" id="supplierAddForm" action="${basePath}/admin/supplier/save">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="sn"> sn </label>

										<div class="col-sm-9">
											<input type="text" id="sn" placeholder="供应商列号" class="col-xs-10 col-sm-5" name="sn" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="name" placeholder="供应商名称" name="name" class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="standard"> 法人 </label>

										<div class="col-sm-9">
											<input type="text" id="legalPerson" placeholder="法人" class="col-xs-10 col-sm-5" name="legalPerson"/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="purchasePrice"> 电话 </label>

										<div class="col-sm-9">
											<input type="text" id="tel" placeholder="电话" class="col-xs-10 col-sm-5" name="tel"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="postcode" placeholder="邮编" class="col-xs-10 col-sm-5" name="postcode"/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="wholesalePrice"> 地址 </label>

										<div class="col-sm-9">
											<input type="text" id="address" placeholder="地址" class="col-xs-10 col-sm-5" name="address"/>
