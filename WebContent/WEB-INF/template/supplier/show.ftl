						...
						<div class="row">
							<div class="col-xs-12">
								...
								<!--
                                	表单开始
                                -->
								<form class="form-horizontal" role="form" method="" id="supplierAddForm" action="">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="sn"> sn </label>

										<div class="col-sm-9">
											<input type="text" id="sn" placeholder="供应商列号" class="col-xs-10 col-sm-5" name="sn" value="${supplier.sn}" disabled/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="name" placeholder="供应商名称" name="name" class="col-xs-10 col-sm-5" value="${supplier.name}" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="legalPerson" placeholder="供应商法人" class="col-xs-10 col-sm-5" name="legalPerson" value="${supplier.legalPerson}" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="tel" placeholder="供应商电话" class="col-xs-10 col-sm-5" name="tel" value="${supplier.tel}" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="postcode" placeholder="供应商邮编" class="col-xs-10 col-sm-5" name="salePrice" value="${supplier.postcode}" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="address" placeholder="供应商地址" class="col-xs-10 col-sm-5" name="address" value="${supplier.address}" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											...
											<div>
												...
												<textarea class="form-control" id="remark" placeholder="此处填写备注" readonly>${supplier.remark}</textarea>
											</div>
