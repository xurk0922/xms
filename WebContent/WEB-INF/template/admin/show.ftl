							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="" id="partAddForm" action="">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="sn" placeholder="管理员列号" class="col-xs-10 col-sm-5" name="sn" value="${admin.sn}" disabled/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="name" placeholder="配件名称" name="name" class="col-xs-10 col-sm-5" value="${admin.name}" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="name" placeholder="管理员用户名" name="username" class="col-xs-10 col-sm-5" value="${admin.username}" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="name" placeholder="管理员密码" name="password" class="col-xs-10 col-sm-5" value="${admin.password}" disabled/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<select class="width-40 chosen-select" id="filiale" data-placeholder="选择所属分公司" name="filialeId" disabled>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<select class="width-40 chosen-select" id="role" data-placeholder="选择一个角色" name="roleId" disabled>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											...
											<div>
												...
												<textarea class="form-control" id="remark" placeholder="此处填写备注" readonly>${admin.remark}</textarea>
											</div>
