						...
						<div class="row">
							<div class="col-xs-12">
								...
								<!--
                                	表单开始
                                -->
								<form class="form-horizontal" role="form" method="POST" id="adminAddForm" action="${basePath}/admin/save">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="sn"> sn </label>

										<div class="col-sm-9">
											<input type="text" id="sn" placeholder="管理员列号" class="col-xs-10 col-sm-5" name="sn" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="username"> 管理员账号 </label>

										<div class="col-sm-9">
											<input type="text" id="username" placeholder="管理员账号" name="username" class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="password" placeholder="管理员密码" name="password" class="col-xs-10 col-sm-5" />
											
										</div>
										
										<div class="col-sm-9">
											<input type="text" name="password2" placeholder="确认密码" class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="name"> 管理员名字 </label>

										<div class="col-sm-9">
											<input type="text" id="name" placeholder="管理员名字" class="col-xs-10 col-sm-5" name="name"/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="filiale">管理员所属公司 </label>

										<div class="col-sm-9">
											
											<select class="width-40 chosen-select" id="filiale" data-placeholder="选择一个公司" name="filialeId">
												<option value="">&nbsp;</option>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="role"> 管理员所属角色 </label>

										<div class="col-sm-9">
											
											<select class="width-40 chosen-select" id="role" data-placeholder="选择一个 管理员角色" name="roleId">
												<option value="">&nbsp;</option>
												<#list roles as role>
