					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="POST" id="searchForm" action="${basePath}/admin/purchase/getReport">
									...
									<div class="form-group">
						                ...
						                <div class="input-group date form_date col-sm-3" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
						                	...
						                	<input type="hidden" id="type" name="type" value="供应商" />
								...
								<!--startprint-->
											<div class="col-sm-11">
												<table id="supplierList" class="table table-striped table-bordered table-hover">
													<thead>
														<td>供应商编号</td>
														<td>供应商名</td>
														<td>供应商法人</td>
				...
				$.ajax({
					...
					success:function(data) {
						for (var key in data) {
							...
							var text = "<tr>"+ "<td>" + obj.sn + "</td>" + "<td>" + obj.name + "</td>"+  "<td>" + obj.legalPerson + "</td>" + "<td>" + data[key] + "</td>" +"</tr>";
							
							$("#supplierList tbody").append(text);
						}
					}
				});
			});
